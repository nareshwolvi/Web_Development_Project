...
//Assigning current img src to image tag in popup
const popupimage = document.getElementById("popup-image");
popupimage.src = slides[currSlideIndex].src;
...
function openpopup(){
    ...
    //when u open the popup it should stop the timer
...
function closepopup(){
    ...
    resetInterval(); //Resume Changing the slides
